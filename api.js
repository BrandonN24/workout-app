...
exports.setApp = function (app, client) {
  ...
  app.post('/api/searchExercise', async (req, res, next) => {
    ...
    try {
      ...
      const result = await db
        .collection('exerciseInfo')
        .find({ public: searchPublic })
        .toArray();

      result.push(
        await db.collection('exerciseInfo').find({ public: 'public' }).toArray()
      );
  ...
  app.post('/api/searchWorkout', async (req, res, next) => {
    ...
    try {
      ...
      result.push(
        await db.collection('workoutInfo').find({ public: 'public' }).toArray()
      );
  ...
  app.post('/api/deleteExercise', async (req, res, next) => {
    ...
    try {
      ...
      const result = await db
        .collection('exerciseInfo')
        .deleteOne({ name: eName, public: userName });
  ...
  app.post('/api/deleteWorkout', async (req, res, next) => {
    ...
    try {
      ...
      const result = await db
        .collection('workoutInfo')
        .deleteOne({ name: wName, public: userName });
